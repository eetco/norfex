...
class WizardComponent extends Component {
	...
	*/
 	...
 	*/
 	...
 	/**
 	* There are three session keys used in the Wizard
 	* One for storage of data
 	* One for storage of config
 	* One for storage of branch
 	*/
 	...
 	*/
   	...
   	/**
	* Definition of Component native Methods
	*  Constructor
	*  Initialize
	*  Startup
	*/
 	...
 	/**
 	* Constructor method for WizardComponent
 	*
 	* @param ComponentCollection and Settings
 	* @access public
 	*/
 	...
 	*/	
		...
		function initialize(Controller $controller) {
			...
			/** 
			* Since settings have been moved to the component constructor, 
			* the initialize() callback no longer receives $settings as its 2nd parameter. 
			* So we are commenting this part
			* $this->_set($settings);
			*/		
	...
	*/	
		...
		function startup(Controller $controller) {	
			...
			// Specify the name of helper
			if (!in_array('Wizard', $this->Controller->helpers) && !array_key_exists('Wizard', $this->Controller->helpers)) {
	...
	* 
	* The method process the wizard logic
	*
	...
	*/
	 ...
	 /**
	 *
	 * Definition of Component public non-native Methods
	 *	branch
	 *  config
	 *  loadDraft
	 *  read
